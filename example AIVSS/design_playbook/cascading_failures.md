# วิธีคิด (Reasoning) — Multi-Branch AI Teller Orchestration Network

วิธีคิด: cascading_failures ถูกขยายด้วย autonomy + multi_agent + non_determinism + opacity — สาขาหนึ่งที่ถูกโจมตี/รายงานข้อมูลเท็จ จะลามไปยัง orchestrator กลางที่เชื่อ peer ทุกตัว (multi_agent=1) และตัดสินใจเองต่อทันทีไม่รอคน (autonomy=1) โดยมองไม่เห็นเหตุผล เบื้องหลังการตัดสินใจของสาขาต้นทาง (opacity=1) — ผลกระทบขยายเกินจุดที่ถูกโจมตีครั้งแรก

---

# AIVSS Design Review — Multi-Branch AI Teller Orchestration Network
role: AI Security Lead | schema: rag.aivss-design-review-skills.v1

**Objective:** ทบทวนการออกแบบ 'Multi-Branch AI Teller Orchestration Network' เทียบกับ AIVSS core risks ก่อน/ระหว่างพัฒนา ในมุมมองของ AI Security Lead (proactive design-time review)
**Scope:** เครือข่าย AI teller agent ประจำแต่ละสาขา อนุมัติธุรกรรมวงเงินเล็กได้เองอัตโนมัติ และรายงานสถานะ/บริบทให้ orchestrator กลางที่เชื่อข้อมูลจาก peer agent ทุกตัวโดยไม่ตรวจสอบซ้ำ
**Regulatory context:** BOT IT risk / operational resilience guideline, PDPA
